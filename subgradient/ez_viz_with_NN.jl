...
# ╔═╡ 9a45e0ba-9d07-413e-acfc-f440699b518b
md"""
**(?)** Where to put this notebook?
- math
- DL
"""
...
Let $X$ and $y$ be data and labels. Then our goal is to minimize the loss function
```math
...
begin
  X = collect(range(-1, 1, length=10_000))
  shuffle!(X)
  X[1:10]
end
