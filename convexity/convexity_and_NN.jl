...
# ╔═╡ 8531f8dc-a0d0-4bd3-9e3c-22fc97ea87a7
md"""
# Convexity and Multilayer Perceptrons
Multilayer Perceptrons
(abbr. MLP, aka Fully Connected Neural Networks)
are often considered as the most basic Neural Network.

Come to think of it: Most often such networks are composed of
several layers of affine transformation and RELU. It is easy to see
that RELU is a convex function, and that the composition
of an affine function and a convex function results in a convex
function as well. Even the most frequently used loss functions,
i.e. Mean Square Error and Cross Entropy Loss, are convex functions.
Besides, the objective of training an MLP is minimizing the loss function.

Even though not often taught in this way, the above seems to suggest
a strong relation between convex optimization and MLP training.
